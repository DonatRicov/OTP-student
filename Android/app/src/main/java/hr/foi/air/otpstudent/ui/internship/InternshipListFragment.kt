...
class InternshipListFragment : Fragment(R.layout.fragment_internship_list) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            viewModel.state.collectLatest { s ->
                ...
                tvSelectedFilters.visibility =
                    if (s.activeFiltersText.isBlank()) View.GONE else View.VISIBLE
